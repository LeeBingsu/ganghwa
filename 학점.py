...
F_prob = {
    "F": 0.0, "D-": 0.15, "D": 0.15, "D+": 0.15, "C-": 0.15, "C": 0.15, "C+": 0.15, "B-": 0.15, "B": 0.15,
    "B+": 0.2, "A-": 0.25, "A": 0.3, "A+": 0.35, "AA": 0.4, "S": 0.45, "Goat": 0.8, "졸업": 0.0
}

base_prob = {
    "F": {"success": 0.8, "failure": 0.20},
    "D-": {"success": 0.7, "failure": 0.15},
    "D": {"success": 0.65, "failure": 0.20},
    "D+": {"success": 0.6, "failure": 0.25},
    "C-": {"success": 0.55, "failure": 0.30},
    "C": {"success": 0.5, "failure": 0.35},
    "C+": {"success": 0.45, "failure": 0.40},
    "B-": {"success": 0.4, "failure": 0.45},
    "B": {"success": 0.35, "failure": 0.5},
    "B+": {"success": 0.3, "failure": 0.5},
    "A-": {"success": 0.25, "failure": 0.5}, 
    "A": {"success": 0.2, "failure": 0.5},
    "A+": {"success": 0.15, "failure": 0.5},
    "AA": {"success": 0.1, "failure": 0.5},
    "S": {"success": 0.05, "failure": 0.5},
    "Goat": {"success": 0.2, "failure": 0},
...
def test():
    ...
    inp = turtle.textinput(f'문제{n}:{T}', f'{Q}')
